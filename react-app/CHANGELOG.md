...
* Less strict on React versions.

## 9.0.0 (2016-09-22)

#### Internal Changes

* Archetype now supports React 15.

## 8.3.0 (2016-09-20)

#### Internal Changes

* Speed up Stylus builds by upgrading `stylus-relative-loader` and
  using the new `precacheImportVariables` option.

## 8.0.0 (2016-08-30)

#### Internal Changes

* Updated the `eslint` package to `^2.0.0`
* Migrated from `eslint-config-defaults` to `eslint-config-walmart`

## 7.3.0 (2016-08-26)

#### Internal Changes

* Webpack configs are now extendable by apps.

## 7.2.0 (2016-08-09)

#### Internal Changes

* Add optional support for CSS Modules and CSS Next.
